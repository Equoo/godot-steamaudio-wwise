...
void SteamAudioDynamicGeometry::process_internal(double delta) {
	...
	IPLMatrix4x4 new_trf{
		{
				{ static_cast<IPLfloat32>(right.x), static_cast<IPLfloat32>(right.y), static_cast<IPLfloat32>(right.z), static_cast<IPLfloat32>(orig.x) },
				{ static_cast<IPLfloat32>(up.x), static_cast<IPLfloat32>(up.y), static_cast<IPLfloat32>(up.z), static_cast<IPLfloat32>(orig.y) },
				{ static_cast<IPLfloat32>(fwd.x), static_cast<IPLfloat32>(fwd.y), static_cast<IPLfloat32>(fwd.z), static_cast<IPLfloat32>(orig.z) },
				{ 0., 0., 0., 1. },
		}
	};
...
void SteamAudioDynamicGeometry::register_geometry() {
	...
	IPLMatrix4x4 trf = IPLMatrix4x4{ {
			{ static_cast<IPLfloat32>(scale.x), 0., 0., 0. },
			{ 0., static_cast<IPLfloat32>(scale.y), 0., 0. },
			{ 0., 0., static_cast<IPLfloat32>(scale.z), 0. },
			{ 0., 0., 0., 1. },
	} };
